...
| A10 | mode 差异逻辑收口 | A10-0/1/2 完成，待本地测试 | 🚧 |
| A11 | 消息流窗口 | 未开始 | ⏳ |
| A12 | 高级动画 | 未开始 | ⏳ |
...
A10-1  聊天页挂载基础设施（共性）← 已完成，待测试
A10-2  extra_sticky（含折叠悬浮球）← 已完成，待测试
...
#### A10-2：extra_sticky 常驻 UI（已完成，待本地测试）
