                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                    ...
                                    child: const Text('复位', style: TextStyle(fontSize: 11, color: Color(0xFF2979FF), fontWeight: FontWeight.bold)),
                                  ),
                                ],
                              ),
                              Slider(
                                value: rotation.clamp(-180.0, 180.0).toDouble(), min: -180, max: 180, activeColor: const Color(0xFF2979FF),
