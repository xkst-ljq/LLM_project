...
- 当前 HUD 处理为：抽屉展开时右下角 HUD 上移；后续仍需正式美化 / 折叠 / 合并到底栏。
...
> 继续 `ASSEMBLY_HANDOFF.md` 的上下文，当前分支是 `arena/019f9cee-llm-project`，A2/A6/A3-1/A3-2/A3-3/A3-4/A7 基础版已完成，A7.5/A5-0 Assembly 资产区最小补全已完成待本地测试。通过后继续 A5 Assembly 内 linker 连线，打通 `button → linker → page_router`。请遵守每一步完成后 commit/push、非阻塞问题并入下一步处理的节奏。
