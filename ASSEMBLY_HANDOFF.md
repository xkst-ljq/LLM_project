...
### 下一步建议
- 进入 A9.5-2：资产区补齐基础原子
- 优先开放：图片、输入框、开关、滑块、下拉、状态点、分割线
- 先保证能拖入 / 移动 / 保存 / 预览，不急着做复杂编辑器
...
> 继续 `ASSEMBLY_HANDOFF.md` 的上下文，当前分支是 `arena/019f9cee-llm-project`，A2/A6/A3-1/A3-2/A3-3/A3-4/A7/A7.5/A5-0/A4/A5/A8/A9 已完成，A9.5 通用模板基础版规划已完成。下一步进入 A9.5-2：资产区补齐基础原子（图片、输入框、开关、滑块、下拉、状态点、分割线），先保证能拖入 / 移动 / 保存 / 预览。请遵守每一步完成后 commit/push、非阻塞问题并入下一步处理的节奏。
